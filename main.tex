...
\makecvheader
    ...
    \begin{paracol}{2}
        ...
        \cvsection{TECH STACK}
            \begin{sloppypar*}
                \cvtags{Java, Python,C\#, C++, Groovy, Bash/PowerShell}
                \medskip

                \cvtags{Spring, Wicket, Hibernate, Flask, SQLAlchemy, Pydantic, REST APIs}
                \medskip
    ...
    \begin{itemize}[leftmargin=1em,itemsep=0.3em,topsep=0pt]
      ...
      \item \textbf{Bloom Filter-Based Multicast\cvreference{\faGithub}{https://github.com/AAlexandros}}:
            Prototype ICN \textbf{Publish/Subscribe} infrastructure developed as part of EU project \textbf{POINT}.
