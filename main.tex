...
%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
\aboutme{Software engineer and Ph.D. candidate with 8+ years of experience building scalable, reliable systems.
    ...
    \begin{paracol}{2}
        ...
        \cvsection{Experience}
            ...
            \begin{itemize}
                ...
                \item Designed and deployed the system architecture and infrastructure (Flask backend, SQLAlchemy, Azure App Service, Docker, CI/CD with GitHub Actions).
        ...
        \cvsection{Publications}
            \cveventSecond{SecureCyclon: Dependable Peer Sampling}{ICDCS 2023}
            \begin{itemize}
            ...
            \cveventSecond{CliqueSensus: Ephemeral Overlays for Committee-based PoS Blockchains} {Middleware 2025}
            \begin{itemize}
        ...
        % ----- PROJECTS -----
        \cvsection{Projects}
            \cveventSecond{Crypto Games}{\cvreference{\faGithub}{https://github.com/AAlexandros}}
            \begin{itemize}
            ...
            \cveventSecond{Bloom Filter-Based Multicast for Information Centric Networks}{\cvreference{\faGithub}{https://github.com/AAlexandros}}
            \begin{itemize}
            ...
            \cveventThird{Social Network Recommendation}{{}}
            \begin{itemize}
