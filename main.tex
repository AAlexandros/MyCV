...
\begin{document}
    ...
    \begin{paracol}{2}
        ...
        \cvsection{Projects}
            ...
            \cveventSecond{Bloom Filter-Based Multicast for Information Centric Networks}{\cvreference{\faGlobe}{https://cordis.europa.eu/project/id/643990}{}}
            \begin{itemize}
